<template>
  <div>
    <vxe-toolbar ref="xToolbar" custom export>
      <template #buttons>
        <vxe-button @click="exportDataEvent">导出PDF</vxe-button>
      </template>
    </vxe-toolbar>
    <vxe-table
      border
      ...
      <vxe-column field="orderNo" title="订单号"></vxe-column>
      <vxe-column field="productNo" title="产品编号"></vxe-column>
      <vxe-column field="productName" title="产品名称"></vxe-column>
      <vxe-column field="realNum" title="真实数量"></vxe-column>
      <vxe-column field="plannedNum" title="规划数量"></vxe-column>
      <vxe-column field="describe" title="描述"></vxe-column>
    </vxe-table>
  </div>
</template>
